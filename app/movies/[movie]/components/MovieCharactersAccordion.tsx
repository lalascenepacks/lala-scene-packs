...
function getUser(fileName: string) {
...
export default function MovieCharactersAccordion({
  grouped,
}: {
              ...
              <div>
                {packs.map((item, index) => (
                  <div
                    ...
                    style={{
                      display: "grid",
                      gridTemplateColumns: "1.8fr 120px 120px 140px",
                      padding: "18px 20px",
